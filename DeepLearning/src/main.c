...
void try_hw1()
{
    ...
    n.n = 2;
    n.layers = calloc(n.n, sizeof(layer));
    n.layers[0] = make_convolutional_layer(1, 8, 3, 1, 1);
//    n.layers[1] = make_activation_layer(RELU);
//    n.layers[2] = make_convolutional_layer(28, 28, 16, 3, 1);
//    n.layers[3] = make_activation_layer(RELU);
//    n.layers[4] = make_connected_layer(784, 10);
    n.layers[1] = make_activation_layer(SOFTMAX);
