...
# Hidden
def test_test_preds_bakeoff_d5_3_english():
    preds = open("bakeoff-test-en.preds")
    gold = open("hidden_data/en-ud-test-key.txt")
...
# Hidden
def test_test_preds_bakeoff_d5_4_norwegian():
    preds = open("bakeoff-test-nr.preds")
    gold = open("hidden_data/no_bokmaal-ud-test-key.txt")
